...
The MEDF platform is deployed and publicly accessible at \url{https://ccds25-0582-medf-api.streamlit.app}, active as of the submission date (April 17, 2026). The complete source code, framework YAML definitions and test suite are available at \url{https://github.com/benjaminyjr17/ccds25-0582-medf}. Local setup instructions are provided in the repository README, enabling full reproduction of all results presented in this report.
