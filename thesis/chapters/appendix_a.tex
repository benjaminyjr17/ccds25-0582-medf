...
\begin{table}[H]
\centering
\caption{MEDF API Endpoint References.}
\label{tab:api_ref}
...
The primary request schemas are defined as Pydantic models in \texttt{app/models.py}. The critical fields are:
...
\begin{flushleft}
{\footnotesize\texttt{transparency\_explainability}}, {\footnotesize\texttt{fairness\_nondiscrimination}}, {\footnotesize\texttt{safety\_robustness}}, {\footnotesize\texttt{privacy\_data\_governance}}, {\footnotesize\texttt{human\_agency\_oversight}}, and {\footnotesize\texttt{accountability}}.
\end{flushleft}
...
# Local development; use deployed API base URL in production.
