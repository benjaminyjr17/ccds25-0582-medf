...
The MEDF platform features an interactive, web-based dashboard built with Streamlit. This interface provides a user-friendly environment for analysts, developers, and other stakeholders to conduct ethical evaluations without directly interacting with the backend API or codebase. The dashboard is designed to guide the user through the evaluation workflow, from configuration to results analysis. This chapter describes the critical features and components of the user interface, illustrated with screenshots captured from the live deployment described in Section~9.4.
...
\caption{Evaluation Configuration: dimension score sliders, framework selection, and stakeholder weight customization.}
...
\caption{Evaluation Results: overall score, framework breakdown, and dimensional contributions.}
...
\caption{Conflict Detection: stakeholder conflict matrix heatmap.}
...
\caption{Pareto Resolution: consensus optimization results.}
...
\caption{Case Study Browser: pre-configured case studies with system descriptions and evidence sources.}
...
\caption{Case Study 1 (Facial Recognition) Results: overall score of 0.3379 and per-stakeholder breakdown.}
