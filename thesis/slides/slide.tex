...
\title[Multi-Stakeholder Ethical Decision Framework]{%
  {\fontsize{19}{23}\selectfont Multi-Stakeholder Ethical Decision-Making Frameworks for AI Systems}}
\subtitle{CCDS25-0582 Final-Year Project}
...
\begin{frame}{Backup: Framework Weight Vectors}
    ...
    \begin{tabular}{l c c c}
        ...
        \midrule
        Transparency        & 0.12 & 0.20 & 0.22 \\
        Fairness            & 0.14 & 0.20 & 0.12 \\
        Safety              & 0.22 & 0.24 & 0.16 \\
        Privacy             & 0.20 & 0.12 & 0.12 \\
        Human Oversight     & 0.18 & 0.12 & 0.18 \\
        Accountability      & 0.14 & 0.12 & 0.20 \\
        \midrule
        \textbf{Total}      & 1.00 & 1.00 & 1.00 \\
        \bottomrule
    \end{tabular}%
    ...
    \vspace{6pt}
    {\small Weights derived from the structural emphasis of each framework (requirement and principle counts).}
\end{frame}
...
\begin{frame}{Backup: End-to-End Evaluation Pipeline}
    ...
    \begin{tikzpicture}[scale=0.78, transform shape,
        node distance=0.9cm,
        block/.style={rectangle, draw=ntu-blue, fill=ntu-blue!10, text width=3.8cm, minimum height=0.7cm, align=center, font=\small},
...
\begin{frame}{Backup: Module Dependency Diagram}
    ...
    \begin{tikzpicture}[scale=0.68, transform shape,
        node distance=0.8cm,
        mod/.style={rectangle, draw=ntu-blue, fill=ntu-blue!10, text width=3.0cm, minimum height=0.6cm, align=center, font=\footnotesize\ttfamily},
