...
\begin{frame}{Live Platform Demo: Evaluation Configuration}
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            {\footnotesize Figure 10.1: Evaluation Configuration:\\ Dimension scores, framework selection, and stakeholder weights.}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Demo: Evaluation Results}
    \begin{columns}[T]
        ...
        \begin{column}{0.48\textwidth}
            ...
            {\footnotesize Figure 10.2: Evaluation Results:\\ Overall score, framework breakdown, and dimensional contributions.}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Demo: Conflict Detection and Pareto Resolution}
    \begin{columns}[T]
        \begin{column}{0.48\textwidth}
            ...
            {\footnotesize Figure 10.3: Conflict Detection:\\ Stakeholder pairwise Spearman correlation heatmap.}
        \end{column}
        \begin{column}{0.48\textwidth}
            \centering
            \includegraphics[width=\linewidth,height=0.55\textheight,keepaspectratio]{images/fig_10_4_pareto.png}

            {\footnotesize Figure 10.4: Pareto Resolution:\\ Consensus optimization with non-dominated trade-offs.}
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Gap Analysis: What Existing Tools Miss}
    ...
    \vspace{4pt}
    {\centering\scriptsize Source: Analysis from Chapter~12.3, based on Morley et al.~\cite{morley2020from} and Zicari et al.~\cite{zicari2021zinspection}.\par}
\end{frame}
