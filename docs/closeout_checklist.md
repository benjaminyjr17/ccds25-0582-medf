...
- 2026-02-28 15:22 C05: Tightened case-study schema test to require `assumptions` and validate non-empty verifiable `source_reference` data while preserving Likert [1,7] checks. Test: pytest -q PASS. Notes: Updated existing `tests/test_case_studies_schema.py` without duplicate test purpose.
