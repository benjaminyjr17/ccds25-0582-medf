...
def build_pdf():
    ...
    intro_text = (
        ...
        f"Board of Admission at the **School of Business and Economics, Maastricht University**, as evidence "
        f"of the required statistical and quantitative background for admission to the **Master of International "
        f"Business**, with a specialisation in **Information Management and Business Intelligence**. As requested, "
        f"this document lists the name of each course, the number of credits received, and a short course "
        f"description. The six courses detailed herein total 42 ECTS and encompass probability theory, "
        f"mathematical statistics, applied data analysis, sampling and survey methodology, information analytics, "
        f"and the application of quantitative models for business decision-making, collectively demonstrating "
        f"the level of statistics and mathematics evaluated by the Board of Admission."
    )
    ...
    pdf.add_course(
        ...
        f"Optimisation models for business decisions; Simulation; Inventory control; Waiting line management (queueing theory); Forecasting; Decision making under uncertainty.",
