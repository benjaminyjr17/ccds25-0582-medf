...
ENDASH = "\u2013"  # U+2013 EN DASH (used in "Management Science – a Modeling")
...
def build_pdf():
    ...
    note_text = f"Note: ECTS credits are calculated using the conversion rate of 2 ECTS = 1 NTU Academic Unit (AU). NTU Academic Units include self{MINUS}study time within their calculation, whereas ECTS credits account for self{MINUS}study time separately."
