...
Tailored for MSc International Business: Sustainable Finance.
...
OUTPUT_PATH = "/home/ubuntu/Yick_Benjamin_Oliver_Course_Descriptions_Statistics_Courses_Maastricht_SF.pdf"
...
def build_pdf():
    ...
    intro_text = (
        ...
        f"International Business**, with a specialization in **Sustainable Finance**. "
        ...
        f"with the master's program in its emphasis on quantitative financial analysis, risk assessment, and "
        f"evidence-based corporate strategy."
    )
